...
6. Apply with `packport configport apply <state-root> <generated> <output> --profile <profile> --target <target> --pack <pack>`.
7. Report which files changed and where configport state was written.
